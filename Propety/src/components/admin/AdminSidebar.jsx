...
const AdminSidebar = ({ activeTab, setActiveTab }) => {
  const menuItems = [
    ...
    { id: 'Agents', icon: UserCircle, label: 'Agents', comingSoon: true },
    { id: 'Enquiries', icon: MessageSquare, label: 'Enquiries', comingSoon: true },
    { id: 'Bookings', icon: Calendar, label: 'Bookings', comingSoon: true },
    { id: 'Reviews', icon: Star, label: 'Reviews', comingSoon: true },

    ...
    <footer className="bg-slate-900 text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 leading-relaxed">
              Leading the way in premium real estate across Panchkula and Mohali.
              We turn your property dreams into reality with transparency and trust.
            </p>
            <div className="flex gap-4">
              <a href="#" className="p-3 rounded-xl bg-white/5 hover:bg-blue-600 transition-all duration-300 group">
              ...
              {['Home', 'Properties', 'About Us', 'Contact Us', 'Privacy Policy'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-slate-400 hover:text-white flex items-center gap-2 group transition-colors">
                    <ChevronRight className="w-4 h-4 text-blue-500 opacity-0 group-hover:opacity-100 transform -translate-x-2 group-hover:translate-x-0 transition-all" />
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-6">
              <a href="tel:+919876543210" className="flex items-center gap-4 group">
                ...
                <div>
                  <span className="block text-sm text-slate-400">Call Support</span>
                  <span className="font-bold">+91 98765 43210</span>
                </div>
              </a>
              <a href="mailto:info@maamansadevi.com" className="flex items-center gap-4 group">
                <div className="p-3 rounded-xl bg-emerald-600/10 text-emerald-500 group-hover:bg-emerald-600 group-hover:text-white transition-all">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <span className="block text-sm text-slate-400">Email Us</span>
                  <span className="font-bold">info@maamansadevi.com</span>
                </div>
              </a>
            </div>
          </div>
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-500 text-sm">
          <p>© 2026 ALL RIGHTS RESERVED. Powered By Digital ORRA</p>

...
export const sendOTP = async (email, otp) => {
    try {
        const subject = 'Your Registration OTP - Maa Mansa Property';
        const message = `
            <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; border: 1px solid #eee; border-radius: 10px; max-width: 500px; margin: auto;">
                <h2 style="color: #2563eb; text-align: center;">Welcome to Maa Mansa Property</h2>
                <p>Hello,</p>
                ...
                <p style="font-size: 10px; color: #aaa; text-align: center;">&copy; 2026 Maa Mansa Property. All rights reserved.</p>
            </div>
        `;
